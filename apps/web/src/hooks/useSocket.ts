...
export const useSocket = () => {
  ...
  useEffect(() => {
    ...
    console.log('User-web: Creating socket connection to:', wsUrl);
    console.log('User-web: Full WebSocket URL:', fullUrl);
    console.log('User-web: Environment variable NEXT_PUBLIC_WS_URL:', process.env.NEXT_PUBLIC_WS_URL);
